...
void ofxKCoreVision::setupControls()
{
    ...
    //PosChange on all GUIs
    
    ofxGuiPanel* cPanel = controls->addPanel(appPtr->calibrationPanel, "Calibration", 1930, 620, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* propPanel = controls->addPanel(appPtr->propertiesPanel, "Camera Properties", 1930, 675, 12, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* oPanel = controls->addPanel(appPtr->optionPanel, "Communication", 1930, 765, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
    ...
    ofxGuiPanel* panel2 = controls->addPanel(appPtr->savePanel, "Settings", 2135, 620, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* trackingPanel = controls->addPanel(appPtr->optionPanel, "Track", 2135, 720, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* trackPanel = controls->addPanel(appPtr->trackedPanel, "Tracked Image", 2281, 495, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	//Source Image
	ofxGuiPanel* srcPanel = controls->addPanel(appPtr->sourcePanel, "Source Image", 1930, 495, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* tPanel = controls->addPanel(appPtr->TemplatePanel, "Distance between:", 1930, 555, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	//Background Image
	ofxGuiPanel* bkPanel1 = controls->addPanel(appPtr->backgroundPanel, "Background", 2473, 620, 10, 7);
